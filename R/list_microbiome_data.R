...
#' @details Data for practice. The source file for these data is the microbiomedatarepo https://github.com/microsud/microbiomedatarepo.
#' @param printtab Print in console or not, defaut is TRUE and will print output. It is duplicate from microbiomeutilities pkg.
#' @export
#' @examples
#' \dontrun{
#' library(jeevanuDB)
